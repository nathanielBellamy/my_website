export const localeFr: any = {
  ...
  magicSquare: {
    ...
    lfo: {
      ...
      pitchSpread: "pas de tangage",
      pitchX: "tangage X",
      pitchY: "tangage Y",
      rollBase: "roulis base",
      rollSpread: "pas de roulis",
      rollX: "roulis X",
      rollY: "roulis Y",
      yawBase: "lacet base",
      yawSpread: "pas de lacet",
      yawX: "lacet X",
      yawY: "lacet Y",
      radius: "rayon",
      radiusBase: "rayon base",
      radiusStep: "pas de rayon",
      rotation: "rotation",
      shape: "forme",
      translation: "translation",
      translationXBase: "X base",
      translationXSpread: "pas de X",
      translationYBase: "Y base",
      translationYSpread: "pas de Y"
    },
    main: {
      active: "actif",
      amplitude: "amplitude",
