...
describe('GrooveJrService', () => {
  ...
  it('should retrieve all GrooveJr content', async () => {
    ...
    const req = httpTestingController.expectOne(req => req.url.startsWith('/api/admin/groovejr'));
  ...
  it('should retrieve GrooveJr content by ID', async () => {
    ...
    const req = httpTestingController.expectOne('/api/admin/groovejr/1');
    expect(req.request.method).toEqual('GET');
    req.flush(mockContent);
  ...
  it('should create GrooveJr content', async () => {
    ...
    const req = httpTestingController.expectOne('/api/admin/groovejr');
