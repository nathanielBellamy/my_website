...
describe('BlogService', () => {
  ...
  it('should retrieve all blog posts', async () => {
    ...
    const req = httpTestingController.expectOne(req => req.url.startsWith('http://localhost:8080/api/admin/blog'));
  ...
  it('should retrieve blog post by ID', async () => {
    ...
    const req = httpTestingController.expectOne('http://localhost:8080/api/admin/blog/1');
    expect(req.request.method).toEqual('GET');
    req.flush(mockPost);
  ...
  it('should create blog post', async () => {
    ...
    const req = httpTestingController.expectOne('http://localhost:8080/api/admin/blog');
