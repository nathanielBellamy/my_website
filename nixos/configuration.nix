...

{
  ...
  services.nginx = {
    ...
    appendHttpConfig = ''
      ...
      add_header Content-Security-Policy "script-src 'self' 'unsafe-inline' 'unsafe-eval' www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ https://js-agent.newrelic.com; object-src 'none'; frame-src www.google.com/recaptcha/ https://www.youtube.com/; connect-src 'self' wss: https://www.google.com/recaptcha/ https://bam.nr-data.net https://bam-cell.nr-data.net; base-uri 'self';" always;
