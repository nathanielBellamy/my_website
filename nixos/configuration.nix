...

{
  ...
  services.nginx = {
    ...
    appendHttpConfig = ''
      ...
      add_header Content-Security-Policy "script-src 'self' 'unsafe-inline' 'unsafe-eval' www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/; object-src 'none'; frame-src www.google.com/recaptcha/; connect-src 'self' wss: https://www.google.com/recaptcha/; base-uri 'self';" always;
